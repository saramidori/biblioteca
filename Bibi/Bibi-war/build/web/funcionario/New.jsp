...
<f:view>
    <html>
        ...
        <h1>New Funcionario</h1>
        <h:form>
            <h:inputHidden id="validateCreateField" validator="#{funcionario.validateCreate}" value="value"/>
            ...
            <br />
            <h:commandLink action="#{funcionario.create}" value="Create"/>
            <br />
            <br />
