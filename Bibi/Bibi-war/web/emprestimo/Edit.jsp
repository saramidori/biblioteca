...
<f:view>
    <html>
        <head>
            ...
            <title>Editing Emprestimo</title>
        ...
        <h:form>
            ...
            <br />
            <h:commandLink action="#{emprestimo.edit}" value="Save">
            ...
            <br />
            <br />
            <h:commandLink action="#{emprestimo.detailSetup}" value="Show" immediate="true">
                <f:param name="jsfcrud.currentEmprestimo" value="#{jsfcrud_class['view.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][emprestimo.emprestimo][emprestimo.converter].jsfcrud_invoke}"/>
            </h:commandLink>
            <br />
